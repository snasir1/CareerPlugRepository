...
public class TinyDB {
    ...
    public ArrayList<CardModel> getListObject(String key, Class<CardModel> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<CardModel> objects =  new ArrayList<>();

    	for(String jObjString : objStrings){
    		CardModel value  = gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public <Date> Date getDate(String key, Class<Date> classOfT){

        String json = getString(key);
        Date value = new Gson().fromJson(json, classOfT);
        if (value == null)
     ...
     */
    public void putDate(String key, Date obj){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	putString(key, gson.toJson(obj));
    }

    public void putListObject(String key, ArrayList<CardModel> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(CardModel obj : objArray){
